"""
Django settings for workalove project.
...
SECRET_KEY = 'dg)$%-dw@u$x6mo60h2i3^6*@o*j@&s#g$2vyw4bjx=(&vbk-w'
...
WSGI_APPLICATION = 'workalove.wsgi.application'
